...
def main():
	...
	for i in range(3, 9) :
		...
		problemfolder = '/home/rohit/Desktop/PT/PT_EvalSwapLG01/'  # change this to your directory for results output - produces large datasets

		problemfolder_db = 'PT_EvalSwapLG01/'  # save main results
